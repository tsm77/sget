(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('ng-block-ui'),exports, require('@angular/common/http'), require('@angular/core'), require('rxjs/operators'), require('ng-block-ui')) :
    typeof define === 'function' && define.amd ? define('ng-block-ui/http', ['@angular/core','ng-block-ui','exports', '@angular/common/http', '@angular/core', 'rxjs/operators', 'ng-block-ui'], factory) :
    (factory(global.ng.core,global.ngBlockUi,(global['ng-block-ui'] = global['ng-block-ui'] || {}, global['ng-block-ui'].http = {}),global.ng.common.http,global.ng.core,global.rxjs.operators,global['ng-block-ui']));
}(this, (function (ɵngcc0,ɵngcc1,exports,http,core,operators,ngBlockUi) { 'use strict';
...
BlockUIHttpSettings.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: BlockUIHttpSettings, factory: function (t) { return BlockUIHttpSettings.ɵfac(t); } });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(BlockUIHttpSettings, [{
...
BlockUIHttpModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function BlockUIHttpModule_Factory(t) { return new (t || BlockUIHttpModule)(); }, imports: [[ngBlockUi.BlockUIModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(BlockUIHttpModule, { imports: [ɵngcc1.BlockUIModule] }); })();
