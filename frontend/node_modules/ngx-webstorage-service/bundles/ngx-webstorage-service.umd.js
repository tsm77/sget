(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-webstorage-service', ['@angular/core','exports', '@angular/core'], factory) :
    (factory(global.ng.core,(global.ngxWebstorageService = {}),global.ng.core));
    ...
    ***************************************************************************** */
    ...
    var /**
     * Transcoder that encodes/decodes `Date` values to ISO strings.
     */ DateIsoStorageTranscoder = /** @class */ (function () {
        function DateIsoStorageTranscoder() {
        }
        /**
         * @param {?} value
         * @return {?}
         */
        DateIsoStorageTranscoder.prototype.encode = /**
         * @param {?} value
         * @return {?}
         */
            function (value) {
         ...
         * @return {?}
         */
        DateIsoStorageTranscoder.prototype.decode = /**
         * @param {?} value
         * @return {?}
         */
            function (value) {
        ...
        return DateIsoStorageTranscoder;
    }());
    /**
    ...
    var /**
     * Transcoder that encodes/decodes `Date` values to epoch timestamps.
     */ DateEpochStorageTranscoder = /** @class */ (function () {
        function DateEpochStorageTranscoder() {
        }
        /**
         * @param {?} value
         * @return {?}
         */
        DateEpochStorageTranscoder.prototype.encode = /**
         * @param {?} value
         * @return {?}
         */
            function (value) {
         ...
         * @return {?}
         */
        DateEpochStorageTranscoder.prototype.decode = /**
         * @param {?} value
         * @return {?}
         */
            function (value) {
        ...
        return DateEpochStorageTranscoder;
    }());
    /**
     ...
     * @type {?}
     */
    var SESSION_STORAGE = new core.InjectionToken('SESSION_STORAGE', { providedIn: 'root', factory: sessionStorageFactory });
    /**
     * @return {?}
     */
     ...
     * @type {?}
     */
    var LOCAL_STORAGE = new core.InjectionToken('LOCAL_STORAGE', { providedIn: 'root', factory: localStorageFactory });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(StorageServiceModule, [{
    ...
    exports.DateIsoStorageTranscoder = DateIsoStorageTranscoder;
    exports.DateEpochStorageTranscoder = DateEpochStorageTranscoder;
