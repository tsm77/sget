...
export declare class NotAuthenticatedErrorProvider implements ErrorProvider {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<NotAuthenticatedErrorProvider, never>;
}

//# sourceMappingURL=not-authenticated-error-provider.service.d.ts.map