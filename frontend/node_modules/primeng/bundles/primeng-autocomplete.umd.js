...
function AutoComplete_div_6_ng_template_5_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function AutoComplete_div_6_ng_template_5_li_0_Template_li_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r61); var option_r55 = ctx.$implicit; var ctx_r60 = ɵngcc0.ɵɵnextContext(3); return ctx_r60.selectItem(option_r55); });
...
'use strict';
    ...
    ***************************************************************************** */
    ...
    var AutoComplete = /** @class */ (function () {
        ...
        AutoComplete.prototype.getFieldData = function (option) {
            var data = utils.ObjectUtils.resolveFieldData(option, this.field);
...
AutoCompleteModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function AutoCompleteModule_Factory(t) { return new (t || AutoCompleteModule)(); }, imports: [[common.CommonModule, inputtext.InputTextModule, button.ButtonModule, api.SharedModule, ripple.RippleModule], ɵngcc4.SharedModule] });
