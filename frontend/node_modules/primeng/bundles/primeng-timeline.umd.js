(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('primeng/timeline', ['@angular/core','@angular/common','exports', '@angular/core', '@angular/common', 'primeng/api'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.common,(global.primeng = global.primeng || {}, global.primeng.timeline = {}), global.ng.core, global.ng.common, global.primeng.api));
...
function Timeline_div_1_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    ...
    var event_r1 = ɵngcc0.ɵɵnextContext().$implicit;
...
var _c1 = function (a1, a2, a3, a4, a5, a6, a7) { return { "p-timeline p-component": true, "p-timeline-left": a1, "p-timeline-right": a2, "p-timeline-top": a3, "p-timeline-bottom": a4, "p-timeline-alternate": a5, "p-timeline-vertical": a6, "p-timeline-horizontal": a7 }; };
'use strict';
...
TimelineModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function TimelineModule_Factory(t) { return new (t || TimelineModule)(); }, imports: [[common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(TimelineModule, { declarations: [Timeline], imports: [ɵngcc1.CommonModule], exports: [Timeline] }); })();
